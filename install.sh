...
if [ -z "$1" ]; then
    ...
    echo -e "${orange}    │   ${green}┌─┐┬ ┬┌┬┐┌─┐┌─┐┌─┐┬─┐┬┌─┐┌┬┐  ┬  ┬┌┬┐┌─┐"
    echo -e "${orange}    │   ${green}├─┤│ │ │ │ │└─┐│  ├┬┘│├─┘ │   │  │ │ ├┤    "
    echo -e "${orange}    │   ${green}┴ ┴└─┘ ┴ └─┘└─┘└─┘┴└─┴┴   ┴   ┴─┘┴ ┴ └─┘   ${neutral}"
    echo -e "${orange}    │   ${yellow}Copyright${reset} (C)${gray} https://t.me/XTRIMER   ${neutral}"
    echo -e "${orange}    └───────────────────────────────────────────────┘${neutral}"
    echo -e "${orange}    ────────────────────────────────────────────────${neutral}"
...
vps_ip=$(curl -s4 https://api.ipify.org)
...
data=$(curl -s https://raw.githubusercontent.com/Guesswho44/izinsc/main/izin)
key=$(echo "$data" | grep "$ip" | awk '{print $2}')
nginx_key_url="https://nginx.org/keys/nginx_signing.key"
dropbear_init_url="https://raw.githubusercontent.com/Guesswho44/zer0/main/fodder/dropbear/dropbear"
dropbear_conf_url="https://raw.githubusercontent.com/Guesswho44/zer0/main/fodder/examples/dropbear"
dropbear_dss_url="https://raw.githubusercontent.com/Guesswho44/zer0/main/fodder/dropbear/dropbear_dss_host_key"
sshd_conf_url="https://raw.githubusercontent.com/Guesswho44/zer0/main/fodder/examples/sshd"
banner_url="https://raw.githubusercontent.com/Guesswho44/zer0/main/fodder/examples/banner"
common_password_url="https://raw.githubusercontent.com/Guesswho44/zer0/main/fodder/examples/common-password"
ws_py_url="https://raw.githubusercontent.com/Guesswho44/zer0/main/fodder/websocket/ws.py"
gotop_url="https://raw.githubusercontent.com/Guesswho44/X/main/gtop"
haproxy_cfg_url="https://raw.githubusercontent.com/Guesswho44/zer0/main/fodder/Haproxy/haproxy.cfg"
xray_conf_url="https://raw.githubusercontent.com/Guesswho44/zer0/main/fodder/nginx/xray.conf"
udp_url="https://raw.githubusercontent.com/Guesswho44/zer0/main/fodder/udp/udp-custom-linux-amd64"
nginx_conf_url="https://raw.githubusercontent.com/Guesswho44/zer0/main/fodder/nginx/nginx.conf"
badvpn_url="https://raw.githubusercontent.com/Guesswho44/zer0/main/BadVPN-UDPWG/badvpn"
openvpn_url="https://raw.githubusercontent.com/Guesswho44/zer0/main/fodder/openvpn/openvpn.zip"
vmess_url="https://raw.githubusercontent.com/Guesswho44/zer0/main/VMess-VLESS-Trojan+Websocket+gRPC/vmess/config.json"
vless_url="https://raw.githubusercontent.com/Guesswho44/zer0/main/VMess-VLESS-Trojan+Websocket+gRPC/vless/config.json"
trojan_url="https://raw.githubusercontent.com/Guesswho44/zer0/main/VMess-VLESS-Trojan+Websocket+gRPC/trojan/config.json"
shadowsocks_url="https://raw.githubusercontent.com/Guesswho44/zer0/main/VMess-VLESS-Trojan+Websocket+gRPC/shadowsocks/config.json"
...
url="https://github.com/Guesswho44/xD/raw/main/SSH/project.zip"
...
wget -q -O /etc/zer0tunnel.txt $banner_url && chmod +x /etc/zer0tunnel.txt >/dev/null 2>&1 || echo -e "${red}Failed to download zer0tunnel.txt${neutral}"
else
echo -e "${yellow}banner_url is not set, skipping download of zer0tunnel.txt${neutral}"
fi
...
wget --no-check-certificate -O /opt/bbr.sh https://raw.githubusercontent.com/Guesswho44/zer0/main/files/bbr.sh
...
documentation="Documentation=https://t.me/zer0tunnell"
create_service() {
local name=$1
local description=$2
local exec_start=$3
...
create_service "vmess" "zer0Tunnel Server Xray Instance" "/usr/local/bin/xray run -config /etc/xray/vmess/%i.json"
create_service "vless" "zer0Tunnel Server Xray Instance" "/usr/local/bin/xray run -config /etc/xray/vless/%i.json"
create_service "trojan" "zer0Tunnel Server Xray Instance" "/usr/local/bin/xray run -config /etc/xray/trojan/%i.json"
create_service "shadowsocks" "zer0Tunnel Server Shadowsocks Instance" "/usr/local/bin/xray run -config /etc/xray/shadowsocks/%i.json"
...
Documentation=https://t.me/zer0tunnel
...
wget -q -O /root/.bot/bot.zip https://raw.githubusercontent.com/Guesswho44/zer0/raw/main/bot.zip
